...
class WeChatService(BaseWeChatAPI):
    ...
    async def get_provider_token(self, provider_secret):
        """
        获取服务商凭证
    ...
    async def get_suite_token(self, suite_id, suite_secret, suite_ticket):
        """
        获取第三方应用凭证
    ...
    async def get_login_info(self, auth_code, provider_access_token=None):
        """
        获取企业号登录用户信息
