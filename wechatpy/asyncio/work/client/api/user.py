...
class WeChatUser(BaseWeChatAPI):
    ...
    async def create(
        ...
        **kwargs,
        ...
        return await self._post("user/create", data=user_data)
    ...
    async def get(self, user_id):
        ...
        """
        return await self._get("user/get", params={"userid": user_id})
    ...
    async def delete(self, user_id):
        ...
        """
        return await self._get("user/delete", params={"userid": user_id})
    ...
    async def batch_delete(self, user_ids):
        ...
        """
        return await self._post("user/batchdelete", data={"useridlist": user_ids})
    ...
    async def verify(self, user_id):
        ...
        """
        return await self._get("user/authsucc", params={"userid": user_id})

    async def get_join_qrcode(self, size_type: Optional[int] = None) -> str:
        """
        获取加入企业二维码
        ...
        resp = await self._get("corp/get_join_qrcode", params=params)
        return resp["join_qrcode"]

    async def get_active_stat(self, date: str) -> int:
        """
        获取企业活跃成员数
        ...
        .. warning:: 仅通讯录同步助手可调用。
        """
        resp = await self._post("user/get_active_stat", data={"date": date})
        return resp["active_cnt"]

    async def getuserid(self, mobile: str) -> int:
        """
        手机号获取 userid
        ...
        :return:
        """
        resp = await self._post("user/getuserid", data={"mobile": mobile})
        return resp["userid"]
