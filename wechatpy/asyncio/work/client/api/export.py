...
class WeChatExport(BaseWeChatAPI):
    ...
    async def export_simple_user(self, encoding_aeskey: str, block_size: int = 10**6) -> str:
        """
        导出成员
        ...
        return await self._post("export/simple_user", data=data, result_processor=itemgetter("jobid"))

    async def export_user(self, encoding_aeskey: str, block_size: int = 10**6) -> str:
        """
        导出成员详情
        ...
        return await self._post("export/user", data=data, result_processor=itemgetter("jobid"))

    async def export_department(self, encoding_aeskey: str, block_size: int = 10**6) -> str:
        """
        导出部门
        ...
        return await self._post("export/department", data=data, result_processor=itemgetter("jobid"))

    async def export_taguser(self, tagid: int, encoding_aeskey: str, block_size: int = 10**6) -> str:
        """
        导出标签成员
        ...
        return await self._post("export/taguser", data=data, result_processor=itemgetter("jobid"))

    async def get_result(self, jobid: str) -> dict:
        """
        获取导出结果
        ...
        """
        params = {"jobid": jobid}
        return await self._get("export/get_result", params=params)
