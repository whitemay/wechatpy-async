...
class WeChatTag(BaseWeChatAPI):
    ...
    async def create(self, name: str, tag_id: Optional[int] = None) -> dict:
        """创建标签
        ...
        **注意**： 标签总数不能超过3000个。
        ...
        if tag_id:
            data["tagid"] = tag_id
        return await self._post("tag/create", data=data)

    async def update(self, tag_id: int, name: str) -> dict:
        """更新标签名字
        ...
        **权限说明**：调用的应用必须是指定标签的创建者。
        ...
        return await self._post("tag/update", data={"tagid": tag_id, "tagname": name})

    async def delete(self, tag_id: int) -> dict:
        """删除标签
        ...
        **权限说明**：调用的应用必须是指定标签的创建者。
        ...
        """
        self._validate_tag_id(tag_id)
        return await self._get("tag/delete", params={"tagid": tag_id})

    async def get_users(self, tag_id: int) -> dict:
        """获取标签成员
        ...
        **权限说明**：
        ...
        """
        self._validate_tag_id(tag_id)
        return await self._get("tag/get", params={"tagid": tag_id})
    ...
    async def add_users(
        ...
        **注意**：每个标签下部门、人员总数不能超过3万个。
        ...
        return await self._post("tag/addtagusers", data=data)
    ...
    async def delete_users(
        ...
        **权限说明**：
        ...
        return await self._post("tag/deltagusers", data=data)
