...
class WeChatMessage(BaseWeChatAPI):
    ...
    * 小程序通知消息
    ...
    async def send(self, agent_id, user_ids, party_ids="", tag_ids="", msg=None):
        """
        ...
        data.update(msg)
        return await self._post("message/send", data=data)
    ...
    async def update_taskcard(self, agent_id, user_ids, task_id, replace_name):
        """更新任务卡片消息状态
        ...
        return await self._post("message/update_taskcard", data=data)
