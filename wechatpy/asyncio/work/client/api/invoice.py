...
class WeChatInvoice(BaseWeChatAPI):
    ...
    async def get_info(self, card_id: str, encrypt_code: str) -> dict:
        """查询电子发票
    ...
    async def get_info_batch(self, item_list: List[Dict[str, str]]) -> dict:
        """批量查询电子发票
    ...
    async def update_status(self, card_id: str, encrypt_code: str, reimburse_status: str) -> dict:
        """更新发票状态
    ...
    async def update_status_batch(self, openid: str, reimburse_status: str, invoice_list: List[Dict[str, str]]) -> dict:
        """批量更新发票状态
