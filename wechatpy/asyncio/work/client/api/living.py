...
class WeChatLiving(BaseWeChatAPI):
    ...
    async def create(
        ...
        return await self._post("living/create", data=data)
    ...
    async def modify(
        ...
        return await self._post("living/modify", data=data)

    async def cancel(self, livingid: str):
        """
        取消预约直播
        ...
        return await self._post("living/cancel", data=data)

    async def delete_replay_data(self, livingid: str):
        """
        删除直播回放
        ...
        return await self._post("living/delete_replay_data", data=data)

    async def get_living_code(self, livingid: str, openid: str):
        """
        ...
        return await self._post("living/get_living_code", data=data)

    async def get_user_all_livingid(self, userid: str, cursor: str = None, limit: int = 100):
        """
        获取成员直播 ID 列表
        ...
        return await self._post("living/get_user_all_livingid", data=data)

    async def get_living_info(self, livingid: str):
        """
        获取直播详情
        ...
        return await self._get("living/get_living_info", params=params)

    async def get_watch_stat(self, livingid: str, next_key: str = "0"):
        """
        获取直播观看明细
        ...
        return await self._post("living/get_watch_stat", data=data)

    async def get_living_share_info(self, ww_share_code: str):
        """
        获取跳转小程序商城的直播观众信息
        ...
        return await self._post("living/get_living_share_info", data=data)
