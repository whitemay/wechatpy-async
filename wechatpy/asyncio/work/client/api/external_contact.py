...
class WeChatExternalContact(BaseWeChatAPI):
    ...
    async def get_follow_user_list(self) -> dict:
        """
        获取配置了客户联系功能的成员列表
        ...
        .. code-block:: python
            ...
            # 获取成员用户userid列表数据
            follow_users = await client.external_contact.get_follow_user_list()["follow_user"]
        ...
        """
        return await self._get("externalcontact/get_follow_user_list")

    async def list(self, userid: str) -> dict:
        """
        获取客户列表
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            # 获取外部联系人的userid列表
            follow_users = await client.external_contact.list("user_id")["external_userid"]
        ...
        """
        return await self._get("externalcontact/list", params={"userid": userid})

    async def batch_get_by_user(self, userid: str, cursor: str = "", limit: int = 50) -> dict:
        """
        批量获取客户详情
        ...
        .. code-block:: python
            ...
            external_contact_list = await client.external_contact.batch_get_by_user("user_id", "cursor", 10)["external_contact_list"]
        ...
        return await self._post("externalcontact/batch/get_by_user", data=data)

    async def gen_all_by_user(self, userid: str, limit: int = 50) -> AsyncGenerator[dict, None]:
        """
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            #  获取企业员工添加的所有客户详情列表
            async for i in client.external_contact.gen_all_by_user("user_id", 10):
                print(i)
        ...
        cursor = ""
        while True:
            response = await self.batch_get_by_user(userid, cursor, limit)
            if response.get("errcode") == 0:
                for item in response.get("external_contact_list", []):
                    yield item
    ...
    async def get(self, external_userid: str) -> dict:
        """
        获取客户详情
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            # 接口数据
            data = await client.external_contact.get("external_userid")
            # 外部联系人的自定义展示信息
        ...
        """
        return await self._get("externalcontact/get", params={"external_userid": external_userid})
    ...
    async def add_contact_way(
        ...
        **注意:**
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            # 调用接口
            result = await client.external_contact.add_contact_way(
                type=1,
                scene=1,
                style=1,
                remark="渠道用户",
    ...
    async def get_contact_way(self, config_id: str) -> dict:
        """
        获取企业已配置的「联系我」方式
        ...
        return await self._post("externalcontact/get_contact_way", data=data)
    ...
    async def update_contact_way(
        ...
        return await self._post("externalcontact/update_contact_way", data=data)

    async def del_contact_way(self, config_id: str) -> dict:
        """
        删除企业已配置的「联系我」方式
        ...
        """
        data = optionaldict(config_id=config_id)
        return await self._post("externalcontact/del_contact_way", data=data)

    async def add_msg_template(self, template: dict) -> dict:
        """
        添加企业群发消息模板
        ...
        **注意**：调用该接口并不会直接发送消息给客户/客户群，需要相关的客服人员操作以后才会
        ...
        .. code-block:: python
            ...
            try:
                result = await client.external_contact.add_msg_template(template=template)
        ...
        """
        return await self._post("externalcontact/add_msg_template", data=template)

    async def get_group_msg_result(self, msgid):
        """
        获取企业群发消息发送结果
        ...
        return await self._post("externalcontact/get_group_msg_result", data=data)
    ...
    async def get_user_behavior_data(
        ...
        return await self._post("externalcontact/get_user_behavior_data", data=data)

    async def send_welcome_msg(self, template: dict) -> dict:
        """
        发送新客户欢迎语
        ...
        .. code-block:: python
            ...
            try:
                await client.external_contact.send_welcome_msg(template=template)
            except WeChatClientException as err:
                # 消息发送失败时的处理
                ...
        ...
        """
        return await self._post("externalcontact/send_welcome_msg", data=template)

    async def get_unassigned_list(self, page_id: int = 0, page_size: int = 1000, cursor: Optional[str] = None) -> dict:
        """
        获取离职成员列表
        ...
        return await self._post("externalcontact/get_unassigned_list", data=data)
    ...
    async def transfer(
        ...
        **调用参数注意事项：**
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            try:
                await client.external_contact.transfer(
        ...
        return await self._post("externalcontact/transfer", data=data)

    async def get_corp_tag_list(self, tag_ids: Optional[List[str]] = None) -> dict:
        """
        获取企业标签库
        ...
        **企业客户标签** 是针对企业的外部联系人进行标记和分类的标签，由企业统一配置后，企业
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            # 接口数据
            data = await client.external_contact.get_corp_tag_list(["tag_id1", "tag_id2"])
            # 标签组列表
        ...
        return await self._post("externalcontact/get_corp_tag_list", data=data)

    async def add_corp_tag(
        self,
        ...
        **参数注意事项:**
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            # 创建标签
            result = await client.external_contact.add_corp_tag(
                group_id="GROUP_ID",
        ...
        return await self._post("externalcontact/add_corp_tag", data=data)

    async def edit_corp_tag(self, id: str, name: Optional[str] = None, order: Optional[int] = None) -> dict:
        """
        编辑企业客户标签
        ...
        **注意**: 修改后的标签组不能和已有的标签组重名，标签也不能和同一标签组下的其他标签重名。
        ...
        .. code-block:: python
            ...
            # 修改标签
            try:
                await client.external_contact.edit_corp_tag(id="TAG_ID", name="NEW_TAG_NAME")
            except WeChatClientException as err:
                # 标签修改失败时的处理
                ...
        ...
        return await self._post("externalcontact/edit_corp_tag", data=data)

    async def del_corp_tag(self, tag_id: Optional[str] = None, group_id: Optional[str] = None) -> dict:
        """
        删除企业客户标签
        ...
        **参数注意事项**:
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            try:
                await client.external_contact.del_corp_tag(tag_id="TAG_ID")
            except WeChatClientException as err:
                # 标签删除失败时的处理
                ...
        ...
        .. _删除企业客户标签: https://work.weixin.qq.com/api/doc/90000/90135/9211
            7#%E5%88%A0%E9%99%A4%E4%BC%81%E4%B8%9A%E5%B7%B2%E9%85%8D
            %E7%BD%AE%E7%9A%84%E3%80%8C%E8%81%94%E7%B3%BB%E6%88%91%E3%80%8D%E6%
            96%B9%E5%BC%8F
        ...
        return await self._post("externalcontact/del_corp_tag", data=data)
    ...
    async def mark_tag(
        ...
        **参数注意事项**:
        ...
        .. code-block:: python
            ...
            client = WeChatClient("corp_id", "secret_key")
            try:
                await client.external_contact.mark_tag(
                    userid="USER_ID",
        ...
        return await self._post("externalcontact/mark_tag", data=data)

    async def get_group_chat_list(
        self,
        limit: int,
        status_filter: int = 0,
        ...
        return await self._post("externalcontact/groupchat/list", data=data)

    async def get_group_chat_info(self, chat_id: str) -> dict:
        """
        获取客户群详情
        ...
        return await self._post("externalcontact/groupchat/get", data=data)

    async def add_group_welcome_template(self, template: dict, agentid: Optional[int] = None) -> dict:
        """
        添加群欢迎语素材
        ...
        .. _添加群欢迎语素材: https://work.weixin.qq.com/api/doc/90000/90135/
            92366#%E6%B7%BB%E5%8A%A0%E5%85%A5%E7%BE%A4%E6%AC%A2%E8%BF%8E%E8%
        ...
        return await self._post("externalcontact/group_welcome_template/add", data=data)

    async def update_group_welcome_template(self, template: dict, template_id: str, agentid: Optional[int] = None) -> dict:
        """
        编辑群欢迎语素材
        ...
        data["agentid"] = agentid
        return await self._post("externalcontact/group_welcome_template/edit", data=data)

    async def get_group_welcome_template(self, template_id: str) -> dict:
        """
        获取入群欢迎语素材
        ...
        return await self._post("externalcontact/group_welcome_template/get", data=data)

    async def del_group_welcome_template(self, template_id: str, agentid: Optional[int] = None) -> dict:
        """
        删除入群欢迎语素材
        ...
        return await self._post("externalcontact/group_welcome_template/del", data=data)
