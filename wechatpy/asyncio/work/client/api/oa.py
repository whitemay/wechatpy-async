...
class WeChatOA(BaseWeChatAPI):
    ...
    async def get_template_detail(self, template_id):
        """
        查询审批模板的详情
        ...
        return await self._post("oa/gettemplatedetail", data=data)

    async def get_approval_info(self, start_time, end_time, cursor, size=100, filters=None):
        """
        批量获取审批单号
        ...
        return await self._post("oa/getapprovalinfo", data=data)

    async def get_approval_detail(self, sp_no):
        """
        获取审批申请详情
        ...
        """
        data = {"sp_no": sp_no}
        return await self._post("oa/getapprovaldetail", data=data)
    ...
    async def apply_event(
        ...
        return await self._post("oa/applyevent", data=data)

    async def get_dial_record(
        ...
        return await self._post("dial/get_dial_record", data=data)

    async def get_checkin_data(self, data_type: int, start_time: int, end_time: int, userid_list: List[str]) -> dict:
        """
        获取打卡数据
        ...
        return await self._post("checkin/getcheckindata", data=data)

    async def get_checkin_daydata(self, start_time: int, end_time: int, userid_list: List[str]) -> dict:
        """
        获取打卡日报数据
        ...
        return await self._post("checkin/getcheckin_daydata", data=data)

    async def get_checkin_monthdata(self, start_time: int, end_time: int, userid_list: List[str]) -> dict:
        """
        获取打卡月报数据
        https://developer.work.weixin.qq.com/document/path/93374
        ...
        return await self._post("checkin/getcheckin_monthdata", data=data)

    async def get_corp_checkin_option(self):
        """
        获取企业所有打卡规则
        https://developer.work.weixin.qq.com/document/path/93384
        """
        return await self._post("checkin/getcorpcheckinoption")

    async def get_checkin_option(self, datetime: int, userid_list: List[str]) -> dict:
        """
        获取打卡规则
        ...
        return await self._post("checkin/getcheckinoption", data=data)

    async def get_checkin_schedu_list(self, start_time: int, end_time: int, userid_list: List[str]) -> dict:
        """
        获取打卡人员排班信息
        ...
        return await self._post("checkin/getcheckinschedulist", data=data)

    async def set_checkin_schedu_list(self, group_id: int, items: list, yearmonth: int) -> dict:
        """
        为打卡人员排班
        ...
        return await self._post("checkin/setcheckinschedulist", data=data)

    async def add_checkin_userface(self, user_id: str, user_face: str) -> dict:
        """
        录入打卡人员人脸信息
        ...
        return await self._post("checkin/addcheckinuserface", data=data)

    async def get_hardware_checkin_data(
        ...
        return await self._post("hardware/get_hardware_checkin_data", data=data)

    async def get_open_approval_data(self, third_no: str) -> dict:
        """
        查询自建应用审批单当前状态
        ...
        return await self._post("corp/getopenapprovaldata", data=data)

    async def get_journal_record_list(self, start_time: int, end_time: int, cursor: int, limit: int, filters=None) -> dict:
        """
        批量获取汇报记录单号
        ...
        return await self._post("oa/journal/get_record_list", data=data)

    async def get_journal_record_detail(self, journal_uuid: str) -> dict:
        """
        获取汇报记录详情
        ...
        """
        return await self._post("oa/journal/get_record_detail", data={"journaluuid": journal_uuid})

    async def get_journal_stat_list(self, start_time: int, end_time: int, template_id: str) -> dict:
        """
        获取汇报统计数据
        ...
        return await self._post("oa/journal/get_stat_list", data=data)
    ...
    async def add_meetingroom(
        ...
        return await self._post("oa/meetingroom/add", data=data)
    ...
    async def get_meetingroom_list(
        ...
        return await self._post("oa/meetingroom/list", data=data)

    async def edit_meetingroom(
        self,
        meetingroom_id: int,
        name: str,
        capacity: int,
        ...
        if latitude and longitude:
            data["coordinate"] = {"latitude": latitude, "longitude": longitude}
        return await self._post("oa/meetingroom/edit", data=data)

    async def delete_meetingroom(self, meetingroom_id: int) -> dict:
        """
        删除会议室
        https://developer.work.weixin.qq.com/document/path/93619
        """
        return await self._post("oa/meetingroom/del", data={"meetingroom_id": meetingroom_id})

    async def get_meetingroom_booking_info(
        self,
        ...
        data = {k: v for k, v in data.items() if v is not None}
        return await self._post("oa/meetingroom/get_booking_info", data=data)
    ...
    async def book_meetingroom(
        ...
        return await self._post("oa/meetingroom/book", data=data)

    async def cancle_meetingroom_book(self, meeting_id: str, keep_schedule=None) -> dict:
        """
        取消预定会议室
        https://developer.work.weixin.qq.com/document/path/93619
        ...
        return await self._post("oa/meetingroom/cancel_book", data=data)

    async def get_booking_info_by_meeting_id(self, meetingroom_id: int, meeting_id: str) -> dict:
        """
        根据会议ID查询会议室的预定信息
        https://developer.work.weixin.qq.com/document/path/93619
        ...
        return await self._post("oa/meetingroom/get_booking_info_by_meeting_id", data=data)
