...
class WeChatEMail(BaseWeChatAPI):
    ...
    async def create_group(
        ...
        return await self._post("exmail/group/create", data=data)
    ...
    async def update_group(
        ...
        return await self._post("exmail/group/update", data=data)
    ...
    async def delete_group(self, group_id):
        ...
        :param group_id: 必填，邮件群组 ID，邮箱格式。
        """
        return await self._post("exmail/group/delete", data={"groupid": group_id})
    ...
    async def get_group(self, group_id):
        ...
        :param group_id: 必填，邮件群组 ID，邮箱格式。
        """
        return await self._get("exmail/group/get", params={"groupid": group_id})

    async def search_group(self, fuzzy, group_id=None):
        """
        ...
        return await self._get("exmail/group/search", params=params, result_processor=itemgetter("groups"))

    async def create_public_email(self, email, name, userid_list=None, department_list=None, tag_list=None):
        """
        创建业务邮箱
        ...
        if tag_list:
            data["tag_list"] = {"list": tag_list}
        return await self._post("exmail/publicmail/create", data=data, result_processor=itemgetter("id"))

    async def update_public_email(self, email_id, name=None, userid_list=None, department_list=None, tag_list=None):
        """
        更新业务邮箱
    ...
    async def delete_public_email(self, email_id):
        """
        删除业务邮箱
    ...
    async def get_public_email(self, email_id):
        """
        获取业务邮箱详情
        ...
        :param email_id: 必填，业务邮箱 ID。
        """
        return (await self.batch_get_public_email([email_id]))[0]

    async def batch_get_public_email(self, email_ids):
        """
        获取业务邮箱详情
        ...
        """
        return await self._post("exmail/publicmail/get", data={"id_list": email_ids}, result_processor=itemgetter("list"))

    async def search_public_email(self, fuzzy, email=None):
        """
        模糊搜索业务邮箱
        ...
        if email is not None:
            params["email"] = email
        return await self._get("exmail/publicmail/search", params=params, result_processor=itemgetter("list"))

    async def active_email(self, user_id=None, public_email_id=None):
        """
        启用邮箱
    ...
    async def inactive_email(self, user_id=None, public_email_id=None):
        """
        禁用邮箱
    ...
    async def get_user_option(self, user_id, types):
        """
        获取用户功能属性
    ...
    async def update_user_option(self, user_id, option):
        """
        更改用户功能属性
    ...
    async def get_new_email_count(self, user_id):
        """
        获取用户新邮件数
