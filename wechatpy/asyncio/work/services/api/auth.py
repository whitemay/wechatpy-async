...
class WeChatAuth(BaseWeChatAPI):
    ...
    async def get_pre_auth_code(self):
        """
        获取预授权码
    ...
    async def set_session_info(self, pre_auth_code, app_id=None, auth_type=0):
        """
        设置授权配置
    ...
    async def get_permanent_code(self, auth_code):
        """
        获取企业永久授权码
    ...
    async def get_auth_info(self, auth_code, permanent_code):
        """
        获取企业授权信息
