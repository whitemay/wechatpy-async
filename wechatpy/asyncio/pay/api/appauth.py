...
class WeChatAppAuth(BaseWeChatPayAPI):
    ...
    async def get_access_token(self, openid: str, code: str) -> Dict[str, Any]:
        """
    ...
    async def real_name_auth(self, openid: str, real_name: str, cred_id: str, access_token: str) -> Dict[str, Any]:
        """
