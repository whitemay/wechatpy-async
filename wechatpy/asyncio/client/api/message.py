...
class WeChatMessage(BaseWeChatAPI):
    ...
    async def send_text(self, user_id, content, account=None):
        ...
        使用示例::
            ...
            res = await client.message.send_text('openid', 'text')
    ...
    async def send_image(self, user_id, media_id, account=None):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            res = await client.message.send_image('openid', 'media_id')
    ...
    async def send_voice(self, user_id, media_id, account=None):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            res = await client.message.send_voice('openid', 'media_id')
    ...
    async def send_video(self, user_id, media_id, title=None, description=None, account=None):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            res = await client.message.send_video('openid', 'media_id', 'title', 'description')
        """
        video_data = {
            "media_id": media_id,
        }
    ...
    async def delete_mass(self, msg_id):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            res = await client.message.delete_mass('message id')
    ...
    async def get_mass(self, msg_id):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            res = await client.message.get_mass('mass message id')
    ...
    async def get_autoreply_info(self):
        ...
        使用示例::
            ...
            client = WeChatClient('appid', 'secret')
            info = await client.message.get_autoreply_info()
    ...
    async def get_subscribe_authorize_url(self, scene, template_id, redirect_url, reserved=None):
        """
        构造请求用户授权的url
        详情请参阅：
