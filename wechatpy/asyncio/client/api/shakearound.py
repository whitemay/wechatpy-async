...
class WeChatShakeAround(BaseWeChatAPI):
    ...
    async def apply_device_id(self, quantity, reason, poi_id=None, comment=None):
        """
        申请设备ID
        详情请参考
    ...
    async def update_device(self, device_id=None, uuid=None, major=None, minor=None, comment=None):
        """
        更新设备信息
        详情请参考
        http://mp.weixin.qq.com/wiki/15/b9e012f917e3484b7ed02771156411f3.html
        ...
        return await self._post("shakearound/device/update", data=data)

    async def bind_device_location(self, poi_id, device_id=None, uuid=None, major=None, minor=None):
        """
        配置设备与门店的关联关系
        详情请参考
        http://mp.weixin.qq.com/wiki/15/b9e012f917e3484b7ed02771156411f3.html
        ...
        return await self._post("shakearound/device/bindlocation", data=data)

    async def search_device(self, identifiers=None, apply_id=None, begin=0, count=10):
        """
        查询设备列表
        详情请参考
        http://mp.weixin.qq.com/wiki/15/b9e012f917e3484b7ed02771156411f3.html
        ...
        res = await self._post("shakearound/device/search", data=data, result_processor=lambda x: x["data"])
        return res

    async def add_page(self, title, description, icon_url, page_url, comment=None):
        """
        新增页面
        详情请参考
        ...
        data["comment"] = comment
        res = await self._post("shakearound/page/add", data=data, result_processor=lambda x: x["data"])
        return res

    async def update_page(self, page_id, title, description, icon_url, page_url, comment=None):
        """
        编辑页面信息
        详情请参考
        http://mp.weixin.qq.com/wiki/5/6626199ea8757c752046d8e46cf13251.html
        ...
        data["page_url"] = page_url
        data["comment"] = comment
        res = await self._post("shakearound/page/update", data=data, result_processor=lambda x: x["data"])
        return res

    async def search_pages(self, page_ids=None, begin=0, count=10):
        """
        查询页面列表
        详情请参考
        http://mp.weixin.qq.com/wiki/5/6626199ea8757c752046d8e46cf13251.html
        ...
        res = await self._post("shakearound/page/search", data=data, result_processor=lambda x: x["data"])
        return res
    ...
    async def delete_page(self, page_id):
        ...
        :return: 返回的 JSON 数据包
        """
        return await self._post("shakearound/page/delete", data={"page_id": page_id})

    async def add_material(self, media_file, media_type="icon"):
        """
        上传图片素材
        详情请参考
    ...
    async def bind_device_pages(self, page_ids, bind, append, device_id=None, uuid=None, major=None, minor=None):
        """
        配置设备与页面的关联关系
        详情请参考
        ...
        return await self._post("shakearound/device/bindpage", data=data)

    async def get_shake_info(self, ticket):
        """
        获取摇周边的设备及用户信息
        详情请参考
    ...
    async def get_device_statistics(self, begin_date, end_date, device_id=None, uuid=None, major=None, minor=None):
        """
        以设备为维度的数据统计接口
    ...
    async def get_page_statistics(self, page_id, begin_date, end_date):
        """
        以页面为维度的数据统计接口
        详情请参考
        http://mp.weixin.qq.com/wiki/0/8a24bcacad40fe7ee98d1573cb8a6764.html
    ...
    async def get_apply_status(self, apply_id):
        """
        查询设备ID申请审核状态
        详情请参考
        http://mp.weixin.qq.com/wiki/15/b9e012f917e3484b7ed02771156411f3.html
